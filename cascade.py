...
def cascade():
    ...
    #           #   print("Face: x=%d y=%d w=%d h=%d" %(x, y, w, h))
                # print("Nose: nx=%d ny=%d nw=%d nh=%d" %(nx, ny, nw, nh))

                if file == 'images/light.png':
                ...
                elif file == 'images/glassANDmustache.png' or file == 'images/spider.png':

                    x1 = nx - (mustacheWidth//4)
                    y1 = ny + nh - (mustacheHeight)

                    x2 = nx + nw + (mustacheWidth)
                    y2 = ny + nh + (10*mustacheHeight)


                elif file == 'images/iron.png':


                    x1 = nx - (mustacheWidth//4)
                    y1 = ny + nh - (mustacheHeight)

                    x2 = nx + nw + 4*(mustacheWidth)
                    y2 = ny + nh + (20*mustacheHeight)
                ...
                #mustache = int(mustache)

                # mustache = int(cv2.resize(imgMustache, (mustacheWidth,mustacheHeight), interpolation = cv2.INTER_AREA))
